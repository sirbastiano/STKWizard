...
from STKBridge.eval import evaluator, new_evaluator, user_evaluator, double_evaluator
...
class Pipeline(STK):
     ...
     def genSol2(self, X: list):
          ...
          super().addSensor(SatName='1seed', SenName='Sensor1', params={'coneAngle':15, 'angularResolution':0.1, 'AzEl':[90,-90], 'maxRange':1200})
          ...
          super().addSensor(SatName='2seed', SenName='Sensor1', params={'coneAngle':15, 'angularResolution':0.1, 'AzEl':[90,-90], 'maxRange':1200})
